class Candidate:
    def __init__(self, name, education, experience, skills, projects, certifications, jobDescription, jobSource, companyName, hiringManager):
        self.name = name
